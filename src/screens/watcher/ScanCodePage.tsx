...
const BACKGROUND_IMAGE =
  'https://www.figma.com/api/mcp/asset/a23efeeb-70c2-4a6f-8458-2ccffceca9b2';
...
export const ScanCodePage: React.FC = () => {
  ...
  const debugBottom = Math.max(36, windowHeight * 0.06);
  const debugWidth = Math.min(contentWidth, scaleValue(240, 220, 260));
    ...
    <View style={styles.safeArea}>
      <ImageBackground
        ...
        <TouchableOpacity
          ...
          <Text style={styles.debugButtonText}>Use scanned device</Text>
        </TouchableOpacity>
      </ImageBackground>
    </View>
  );
